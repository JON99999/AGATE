...
4. **Version Update**:
   - Set the application version globally to `0.10.6` in `package.json`, `package-lock.json`, and any other applicable files.
   - Update `HOW_TO_RELEASE_IN_GITHUB_ONLINE.md` to reference `v0.10.6`.
