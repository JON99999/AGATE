...
import { cn, extractFolderId, getSortedShows, getShowShade, isTimeInShow, getActualShowStart, normalizeInterstitial, normalizeInterstitials, getAllRequiredMp3Urls } from "./lib/utils";
import {
  initAuth,
  googleSignIn,
  handleLogout,
    ...
    const initSettings = async () => {
      ...
      try {
        ...
        if (res.ok) {
          ...
          if (serverSettings && (serverSettings.localPathMP3s || serverSettings.localPathLogs || serverSettings.localPathCalendar || (serverSettings.mode && serverSettings.mode !== "Demo"))) {
