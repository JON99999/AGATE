...
export interface LocationsModalProps {
  ...
  // Drive draft IDs
  draftDriveFolderAgate?: string;
  setDraftDriveFolderAgate?: (id: string) => void;
  ...
  editingDriveField: "agate" | "preferences" | "mp3s" | "announcements" | "evergreens" | "shows" | "logs" | null;
  setEditingDriveField: (field: "agate" | "preferences" | "mp3s" | "announcements" | "evergreens" | "shows" | "logs" | null) => void;
            ...
            >
              ...
              >
                ...
                <div className="p-3.5 space-y-3 overflow-y-auto flex-1 custom-scrollbar">
                      ...
                      <details className="text-xs border border-slate-200 rounded p-2 bg-slate-50/50">
                        ...
                        <div className="mt-2.5 space-y-3 pt-2 border-t border-slate-200">
                          ...
                          <div>
                            ...
                            <input
                              type="text"
                              placeholder="Default: [AGATE]/media_evergreens"
                          ...
                          <div>
                            ...
                            <input
                              type="text"
                              placeholder="Default: [AGATE]/media_shows"
                  ...
                  {locationMode === "Drive" && (
                    <div className="space-y-3">
                      {/* AGATE Station Location Container (Unified Root) */}
                      <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-200 space-y-1">
                        ...
                        <p className="text-xs font-sans text-slate-800 select-all truncate leading-relaxed">
                          {(draftDriveFolderAgate && driveFolderDescMap[draftDriveFolderAgate]) ||
                            draftDriveFolderAgate ||
                        ...
                        <div className="flex items-center gap-1.5 pt-0.5">
                          <button
                            type="button"
                            onClick={() => {
                              setEditingDriveField("agate");
                              setTempPasteLink(draftDriveFolderAgate || "");
                            }}
                          ...
                          {draftDriveFolderAgate && (
                            <button
                              type="button"
                              onClick={() =>
                                onOpenDriveFolder(draftDriveFolderAgate)
                              }
            ...
            >
              <div className="flex justify-between items-center pb-2 border-b border-slate-200">
                <h3 className="text-xs font-black uppercase text-blue-600 tracking-wider">
                  {editingDriveField === "agate"
                    ? "AGATE Station Location folder"
              ...
              <div className="flex gap-2 justify-end pt-1 border-t border-slate-200">
                <button
                  type="button"
                  onClick={() => {
                    if (editingDriveField === "agate") {
                      if (setDraftDriveFolderAgate) setDraftDriveFolderAgate("");
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    if (editingDriveField === "agate") {
                      if (setDraftDriveFolderAgate) setDraftDriveFolderAgate(rawId);
                    } else if (editingDriveField === "preferences") {
