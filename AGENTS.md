...
- **Error Link Requirement**: When explicitly asked to "Check your work in Github", always start your analysis of how to fix with the hyperlink of the most recent error that you are looking at from GitHub Actions (e.g., https://github.com/JON99999/Interstitial-er/actions/runs/26315359162/job/77473266567). Ensure this link is prominently featured at the very beginning of that specific response. Under normal conversational flow or unrelated developer queries, this link requirement does not apply.
