...
export const PlaylistSelectModal: React.FC<PlaylistSelectModalProps> = ({
  ...
  const isCurrentlyLoading = loading ?? isLoading ?? false;
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="text-xs text-slate-500 dark:text-slate-400 font-mono flex items-center justify-between pt-1 border-t border-slate-200/60 dark:border-slate-700/60">
                            <span>
                              {playlistShowOptions.currentShowFolderCount && playlistShowOptions.currentShowFolderCount > 1
                                ? `${playlistShowOptions.currentShowFileCount} files in ${playlistShowOptions.currentShowFolderCount} folders`
                                : `${playlistShowOptions.currentShowFileCount} files`}
                            </span>
                    ...
                    (() => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="text-xs text-slate-500 dark:text-slate-400 font-mono flex items-center justify-between pt-1 border-t border-slate-200/60 dark:border-slate-700/60">
                            <span>
                              {playlistShowOptions.nextShowFolderCount && playlistShowOptions.nextShowFolderCount > 1
                                ? `${playlistShowOptions.nextShowFileCount} files in ${playlistShowOptions.nextShowFolderCount} folders`
                                : `${playlistShowOptions.nextShowFileCount} files`}
                            </span>
                            <span className="font-sans text-[10px] uppercase font-bold text-slate-400">
                              {startsInLabel}
                            </span>
