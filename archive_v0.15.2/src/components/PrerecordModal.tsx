...
import { cn, formatHour12, formatTime12 } from "../lib/utils";
...
export interface PrerecordModalProps {
  ...
  setPrerecordTimeInput?: (time: string) => void;
                ...
                <div className="p-3 space-y-3 flex-1 min-h-0 overflow-y-auto custom-scrollbar">
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={cn(
                          "w-[150px] px-2.5 py-1 bg-slate-100 border border-slate-300 rounded text-xs font-mono font-bold text-left select-none cursor-default",
                          colors.accentText,
                        )}
                      >
                        {formatTime12(prerecordTimeInput)}
                      </span>
                    </div>
                                  ...
                                  <div className="flex items-center justify-between gap-1 w-full min-w-0">
                                    <div className="flex items-center gap-1.5 min-w-0">
                                      ...
                                      <span className="text-[10px] font-mono font-bold text-slate-700 truncate">
                                        {formatHour12(show.startHour, show.startMinute)}{" "}
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="w-[140px]">
                          <MilitaryTimeInput
                            ...
                            onChange={(newTime) => {
                              if (setPrerecordTimeInput) {
                                setPrerecordTimeInput(newTime);
                              } else {
                                handleTimeInputChange({
                            ...
                            className={cn(
                              "w-full px-2 py-1 bg-white border border-slate-300 rounded text-xs font-mono font-bold text-slate-800 outline-none transition-all shadow-xs",
                              colors.focusRing,
                            )}
                          />
                        </div>
