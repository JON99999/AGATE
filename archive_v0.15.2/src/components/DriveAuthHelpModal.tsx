      ...
      <div className="bg-white border border-slate-200 rounded-xl w-full max-w-2xl max-h-[85vh] flex flex-col shadow-2xl">
        ...
        <div className="p-6 overflow-y-auto space-y-6 text-slate-700 font-sans text-xs leading-relaxed custom-scrollbar">
          ...
          <div className="space-y-1.5">
            <p>
              This guide explains how the connection methods work in <strong>AMP (Announcement Media Player)</strong> and how to retrieve or set up Google API credentials for secure synchronization across automated broadcast endpoints.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <div className="bg-slate-50/80 border border-blue-200/60 rounded-lg p-3 space-y-1.5">
                ...
                <p className="text-slate-600 leading-relaxed">
                  With an OAUTH Client ID, AMP opens a pop-up login window. Google user email must be preapproved in that Client ID in Google OAUTH. See your admin to be added.
                </p>
              ...
              <div className="bg-slate-50/80 border border-emerald-200/60 rounded-lg p-3 space-y-2">
                ...
                <div className="p-3 bg-white border border-emerald-200 rounded-md space-y-2 text-xs">
                  ...
                  <ol className="list-decimal pl-4 space-y-1.5 text-slate-700">
                    ...
                    <li>Open AMP settings, expand Advanced options, select Option: Access Token, paste the access_token value, and click <strong>Connect</strong>.</li>
                  </ol>
                </div>
            ...
            <div className="space-y-4 text-slate-700">
              ...
              <div className="space-y-1">
                ...
                <ol className="list-decimal pl-4 space-y-1">
                  ...
                  <li>Fill in mandatory App Details (App Name: `AMP`, support email, and developer contact email).</li>
