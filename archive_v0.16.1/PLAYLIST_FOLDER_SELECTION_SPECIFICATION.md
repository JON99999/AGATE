...
### 5.5 Folder Switching Reconciliation Flow
When the broadcaster opens the folder chooser dialog and confirms a switch from Folder A to Folder B on an existing show session:
...
3. **If "No Playlist" / "No Evergreen" is Selected**:
