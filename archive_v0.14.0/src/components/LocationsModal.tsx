...
export interface LocationsModalProps {
  ...
  handleBrowseNative: (type: "calendar" | "mp3s" | "logs") => void;
  handleOpenLocalPath: (path: string) => void;
  ...
  handleOpenDriveFolder: (folderId: string) => void;
  ...
  setShowLocalHelp: (show: boolean) => void;
  animationsDisabled: boolean;
  toggleAnimations: () => void;
  showPixelRuler: boolean;
  togglePixelRuler: () => void;
  handleSaveLocations: (e: React.FormEvent) => void;
}
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <p className="text-xs text-slate-500 mt-0.5">
                          Directory where Agate saves the interstitials
                          configuration.
                        </p>
                      </div>
