...
export default function App() {
      ...
      try {
        ...
        if (res.ok) {
          ...
          if (serverSettings) {
            ...
            } else if (serverSettings.localPathMP3s || serverSettings.localPathLogs || serverSettings.localPathCalendar || (serverSettings.mode && serverSettings.mode !== "Demo")) {
  ...
  const handleBrowseNative = async (
    ...
    try {
      ...
      if (targetField === "calendar") defaultPath = draftLocalPathCalendar || localPathCalendar;
