...
import { cn, extractFolderId, getSortedShows, getShowShade, isTimeInShow, normalizeInterstitial, normalizeInterstitials, getAllRequiredMp3Urls } from "./lib/utils";
import {
  initAuth,
  googleSignIn,
  handleLogout,
...
export default function App() {
  ...
  const addLog = async (entry: LogEntry) => {
    ...
    const enrichedEntry: LogEntry = {
      ...
      assetType: entry.assetType || (entry.status === 'backup play' ? 'audio' : 'script'),
    };
